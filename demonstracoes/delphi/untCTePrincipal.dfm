  ...
  object Panel2: TPanel
    ...
    object GroupBox1: TGroupBox
      ...
      object cbTipoTransp: TComboBox
        ...
        ItemIndex = 0
        TabOrder = 4
        Text = '01 '#8211' Rodovi'#225'rio'
        Items.Strings = (
          '01 '#8211' Rodovi'#225'rio'
          '02 '#8211' A'#233'reo'
          '03 '#8211' Aquavi'#225'rio'
          '04 '#8211' Ferrovi'#225'rio'
          '05 '#8211' Dutovi'#225'rio'
          '06 '#8211' Multimodal')
      end
      object cbTipoUnidade: TComboBox
        Left = 154
        Top = 68
        Width = 135
        Height = 21
